  ...
  async run(client: Client, message: Message, args: string[]) {
    try {
      ...
      const ButtonRow = new MessageActionRow().addComponents(
        ...
        new MessageButton()
          .setLabel(`Comandos de barra diagonal ( / )`)         .setStyle("PRIMARY")
          ...
          .addOptions([
            {
              ...
              value: "Comandos",
              emoji:"<a:comands:997150996566392856>",
            },
            {
              label: "Reglas en mano",
              description: "ten todas las reglas del servidor en tus manos...",
              value: "reglas",
              emoji:"<a:aja:997165566513131550>",
            },
            {
              label: "Ayuda comando",
              description:"ten sujerencias de como usar algunos de mis comandos.",
              value: "ayuda",
              emoji:"<a:dev:997201942377934949>",
            ...
            },
            {
              ...
              value: "inicio",
              emoji:"<a:hola:997151106448765020>",
      ...
      const Menu = new MessageEmbed()
        ...
        .addField("Categorias:", "<a:ff:997202212931510302> Comandos\n<a:ff:997202212931510302> Comandos de barra diagonal")
  ...
  // Menu Embed comandos
      await message.channel.sendTyping();
       let MenuComands = new MessageEmbed()
        ...
        .setDescription("\n\nNota: en este menu estan mis comandos que actualmente estan disponibles. ")
        .addField("Comanos disponible:", "<a:ff:997202212931510302> Comandos\n<a:ff:997202212931510302> Comandos de barra diagonal")
        .setThumbnail("https://i.imgur.com/3KuMHNA.jpg")
      ...
      const regla0 = new MessageEmbed()
        ...
        .setDescription("leer las siguientes reglas atentamente para no ser baneado o expulsado del servido 💙")
        
        .setThumbnail("https://cdn.discordapp.com/attachments/986408651193479169/990311920676519976/20220415_152235.png")
   ...
   .setEmoji("⬅️"),
    ...
    new MessageButton()
      ...
      const regla1 = new MessageEmbed()
        ...
        .setDescription("Está prohibido mandar enlace o enviar la misma palabra para auto promocionarse, se les silenciara automáticamente por un tiempo.")
...
const bregla1 = new MessageActionRow().addComponents(
  ...
  .setDescription ("dices alguna grosería o insultas a un usuario, serás advertido y si sigue así se teles silenciara automáticamente por un tiempo.")
   ...
   .setEmoji("⬅️"),
    ...
    new MessageButton()
      ...
      const regla3 = new MessageEmbed()
        ...
        .setDescription("Este servidor puede haber usuarios menores de 18 años, o si no hubiera también se prohíbe.")
   ...
   .setEmoji("⬅️"),
    ...
    new MessageButton()
      ...
      const regla4 = new MessageEmbed()
        ...
        .setDescription("Este servidor tiene varios  bots anti-raid así que si un <@&934924467770105966> , <@&926913890233778288> o un <@&986407281375739924> u otros rangos, que manipulen o dañen este servidor, serán baneado sin compasión.")
...
const bregla5 = new MessageActionRow().addComponents(
   ...
   .setEmoji("⬅️"),
    ...
    new MessageButton()
        ...
        new MessageButton()
            .setStyle("PRIMARY")
          .setCustomId("button_ahead5").setDisabled(true)
      ...
      const collector = mensaje.createMessageComponentCollector({
       ...
       const CommandsMenu = new MessageEmbed()
        ...
        .setDescription("Seleciona la categoria para poder mostrar los comandos que nesecites")
        .addField("Categorias:", "<a:ff:997151260664942753> Comandos del bot\n<a:ff:997151260664942753> Reglas del server\n<a:ff:997151260664942753> Ayuda con los comandos\n<a:ff:997151260664942753> Inicio")
         .setThumbnail("https://i.imgur.com/3KuMHNA.jpg")
    .setImage(
            "https://cdn.discordapp.com/attachments/717821702180044862/729449197153157160/BARRA.gif"
          )
      ...
      const FunCommands = new MessageEmbed()
        ...
        .addField("Comandos:", `<a:ff:997151260664942753> ${config.prefix}say\n<a:ff:997151260664942753> ${config.prefix}embed`)
        .setFooter({
          text: `${client.user?.username}`,
          iconURL: `${client.user?.displayAvatarURL()}`,
        })
      ...
      collector.on("collect", async (i: MsgComponentInt) => {
        ...
        if (i.customId === "menu_commands" && i.values[0] === "inicio") {
          await i.deferUpdate();
          i.editReply({ embeds: [Menu], components: [ButtonRow] });
        }
